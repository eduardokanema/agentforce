...
- A user can create a mission from a natural-language brief in Plan Mode.
- The user can select one or more workspace paths before planning begins.
- The user can choose approved models and planning profiles before the first run.
- The system can generate an initial mission draft from the brief.
